...
const Quote = ({
  ...
  const [CloseScaleQuotes, customizeCLoseScaleQuote] = useSection(
    `ScaleQuote${number}`
  );
    ...
    <div className="div_quotes">
      ...
      <div {...lupaFocus}>
        <button
          ref={reference}
          id={number}
          className="sn-section-item lupa"
          tabIndex={-1}
          onClick={() => scaleQuote()}
        >
      ...
      <ModalWindow
        ...
        setModalState={{ setScale, scaleStatus }}
      >
        <div
          {...CloseScaleQuotes}
          style={{
        ...
        >
          ...
          <button
            ...
            tabIndex={-1}
            onClick={() => assistant_global(null, "closeQuoteModal")}
          >
